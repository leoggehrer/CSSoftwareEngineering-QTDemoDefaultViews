namespace QTDemoDefaultViews.ConApp
{
    partial class Program
    {
        ...
        private static string SaEmail => "LeoAdmin.QTDemoDefaultViews@gmx.at";
        private static string SaPwd => "1234LeoAdmin";

        private static string AaUser => "AppAdmin";
        private static string AaEmail => "AppAdmin.QTDemoDefaultViews@gmx.at";
        private static string AaPwd => "1234AppAdmin";
        private static string AaRole => "AppAdmin";

        private static string AppUser => "AppUser";
        private static string AppEmail => "AppUser.QTDemoDefaultViews@gmx.at";
