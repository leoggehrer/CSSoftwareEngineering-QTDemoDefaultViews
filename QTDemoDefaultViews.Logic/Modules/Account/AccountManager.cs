...
using QTDemoDefaultViews.Logic.Modules.Exceptions;
using QTDemoDefaultViews.Logic.Modules.Security;
...
namespace QTDemoDefaultViews.Logic.Modules.Account
{
                ...
                if (session != null && session.IsActive)
                {
                    ...
                    if (identity != null)
                    {
                        ...
                        session.JsonWebToken = JsonWebToken.GenerateToken(new Claim[]
                        {
                            ...
                            new Claim(ClaimTypes.System, nameof(QTDemoDefaultViews)),
